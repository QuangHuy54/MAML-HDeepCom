...
def _train(testing_project,is_transfer,vocab_file_path=None, model_file_path=None,model_state_dict=None,num_of_data=-1):
    ...
    if not is_transfer:
        train_instance = train.Train(vocab_file_path=vocab_file_path, model_file_path=model_file_path,code_path=f'../dataset_v2/original/{testing_project}/train_transfer_all.code'
                                    ,ast_path=f'../dataset_v2/original/{testing_project}/train_transfer_all.sbt',nl_path=f'../dataset_v2/original/{testing_project}/train_transfer_all.comment'
                                    ,code_valid_path=f'../dataset_v2/original/{testing_project}/valid_transfer_all.code',nl_valid_path=f'../dataset_v2/original/{testing_project}/valid_transfer_all.comment',
                                    ast_valid_path=f'../dataset_v2/original/{testing_project}/valid_transfer_all.sbt'
