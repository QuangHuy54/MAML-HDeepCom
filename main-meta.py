...
import torch
torch.manual_seed(1)
def _train(training_projects,validating_project,lr,vocab_file_path=None, model_file_path=None,num_of_data=-1):
    ...
    train_instance = metatrain.MetaTrain(training_projects=training_projects,validating_project=validating_project,vocab_file_path=vocab_file_path, model_file_path=model_file_path,lr=lr,num_of_data=num_of_data)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n','--numdata',type=int,default=-1)
    ...
    best_model_dict = _train(training_projects=training_projects, \
                            ...
                            ,model_file_path='../pretrain_model/pretrain.pt',lr=args.learning,num_of_data=args.numdata)
