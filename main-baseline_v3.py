...
def _train(testing_project,is_transfer,vocab_file_path=None, model_file_path=None,model_state_dict=None):
    ...
    if not is_transfer:
        train_instance = train_v2.Train(vocab_file_path=vocab_file_path, model_file_path=model_file_path,code_path=f'../dataset_v2/original/{testing_project}/train_transfer.code'
        ...
        train_instance = train_v2.Train(vocab_file_path=vocab_file_path,code_path=f'../dataset_v2/original/{testing_project}/train.code'
...
def _test(model,testing_projet):
    ...
    test_instance = eval_v2.Test(model,code_path=f'../dataset_v2/original/{testing_project}/valid.code',ast_path=f'../dataset_v2/original/{testing_project}/valid.sbt',nl_path=f'../dataset_v2/original/{testing_project}/valid.comment')
    print('Environments built successfully.\n')
